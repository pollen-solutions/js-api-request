 ...
 * ---------------------------------------------------------------------------------------------------------------------
 ...
 ApiRequest('https://jsonplaceholder.typicode.com/posts?_start=0&_limit=5')
 .then(json => console.log(json))
 .finally(() => console.log('ApiRequest complete'))

 // or for a specific HTTP verbs
 ...
 // -- PUT
 import {ApiPut} from "./lib/ApiRequest"
 ...
 // -- PATCH
 import {ApiPatch} from "./lib/ApiRequest"
